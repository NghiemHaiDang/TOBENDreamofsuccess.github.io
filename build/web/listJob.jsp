<%-- 
    Document   : listJob
    Created on : Apr 27, 2022, 2:42:48 AM
    Author     : Admin
--%>
                                ...
                                <table class="table table-bordered m-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right py-3 px-4" style="width: 100px;">Tên công việc</th>
                                            <th class="text-center py-3 px-4" style="width: 100px;">Mô tả</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">Mức lương</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">ID tính chất công việc</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">ID doanh nghiệp</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">Ngày tuyển dụng</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">Ngày hết hạn</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">Hình ảnh</th>
                                            <th class="text-center align-middle py-3 px-0" style="width: 40px;"><a href="#" class="shop-tooltip float-none text-light" title="" data-original-title="Clear cart"><i class="ino ion-md-trash"></i></a></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${listJob}" var="C">
                                            <tr>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.id}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.job_name}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.description}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.salary}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.categoryid}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.companyid}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.recruitmentdate}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.expirationdate}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.imageurl}</td>
