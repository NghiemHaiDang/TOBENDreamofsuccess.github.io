<%-- 
    ...
    Created on : Apr 27, 2022, 2:43:00 AM
    Author     : Admin
--%>
                                ...
                                <table class="table table-bordered m-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center py-3 px-4" style="width: 100px;">Địa chỉ</th>
                                            <th class="text-right py-3 px-4" style="width: 100px;">Giám đốc</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listCompany}" var="C">
                                            <tr>
                                                ...
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.company_name}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.address}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.ceo}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.phonecompany}</td>
                                                <td class="text-right font-weight-semibold align-middle p-4">${C.imageurlcompany}</td>
