<%-- 
    ...
    Created on : Apr 28, 2022, 8:03:02 AM
    Author     : Admin
--%>
            ...
            <section class="main-content">				
                <div class="row">
                    ...
                    <div class="span7">					
                        ...
                        <form action="editAccount" method="POST" class="form-stacked">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label">Tên đăng nhập:</label>
                                    <div class="controls">
                                        <input type="hidden" placeholder="Tên đăng nhập của bạn" value="${acc.id}" name="idup" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Tên đăng nhập:</label>
                                    <div class="controls">
                                        <input type="text" placeholder="Tên đăng nhập của bạn" value="${acc.username}" name="usname" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Tên hiển thị:</label>
                                    <div class="controls">
                                        <input type="text" placeholder="Tên hiển thị" value="${acc.displayname}" name="displayname" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Địa chỉ email:</label>
                                    <div class="controls">
                                        <input type="email" placeholder="Email của bạn" value="${acc.email}"  name="email" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Mậu khẩu:</label>
                                    <div class="controls">
                                        <input type="password" placeholder="Nhập mật khẩu" value="${acc.password}" name="pass" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Địa chỉ:</label>
                                    <div class="controls">
                                        <input type="text" placeholder="Địa chỉ" value="${acc.address}" name="address" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Số điện thoại:</label>
                                    <div class="controls">
                                        <input type="text" placeholder="Số điện thoại" value="${acc.phone}" name="phone" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
